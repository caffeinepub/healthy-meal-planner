...
import type { T as _T, UserProfile as _UserProfile, UserRole as _UserRole, WeeklyPlan as _WeeklyPlan } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getWeeklyMealPlan(): Promise<WeeklyPlan | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getWeeklyMealPlan();
    ...
    async regenerateMealPlan(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.regenerateMealPlan();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_T_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _T): T {
...
function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_WeeklyPlan]): WeeklyPlan | null {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        healthGoal: from_candid_T_n6(_uploadFile, _downloadFile, value.healthGoal),
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "muscle_gain" in value ? T.muscle_gain : "weight_loss" in value ? T.weight_loss : "balanced_diet" in value ? T.balanced_diet : value;
}
...
function to_candid_T_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: T): _T {
...
function to_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        healthGoal: to_candid_T_n13(_uploadFile, _downloadFile, value.healthGoal),
        displayName: value.displayName
    };
}
function to_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: T): {
    muscle_gain: null;
} | {
    weight_loss: null;
} | {
    ...
    return value == T.muscle_gain ? {
        muscle_gain: null
    } : value == T.weight_loss ? {
        weight_loss: null
    } : value == T.balanced_diet ? {
        balanced_diet: null
    } : value;
}
